...
paraphrase_path = "Tk-Instruct/output/finetuned-v5-paraphrased-instruction/predict_results_save_paraphrase.json"
...
# "Tk-Instruct/output/finetuned-v4-paraphrased-instruction/predict_results_save_paraphrase.json" mean std:  2.3828
...
# "Tk-Instruct/output/finetuned-v5-paraphrased-instruction/predict_results_save_paraphrase.json" mean std:  3.1398
